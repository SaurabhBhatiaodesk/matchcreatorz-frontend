...
interface JobsBookingsCompletedTabProps {
	isBookingList: any;
	limit: any;
	bookingData: any;
	keyword: any;
...
const JobsBookingsCompletedTab: React.FC<JobsBookingsCompletedTabProps> = ({
	isBookingList,
	limit,
	bookingData,
	keyword,
	...
	return (
		<>
			<h5 className="booking-title mb-30">Completed Bookings</h5>
			...
			{!isBookingList ? (
				...
				<ActiveBookingSkeleton limit={limit} type={'Completed'} />
			)}
		</>
	);
};

export default JobsBookingsCompletedTab;
